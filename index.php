...
<html>
  <head>
    ...
    <meta property="og:url" content="http://harukarist.php.xdomain.jp/choju-acchi/" />
    <meta property="og:title" content="鳥獣戯画とあっち向いてほい！" /> 
    <meta property="og:description" content="鳥獣たちが向く方向を当てて戦おう！" /> 
    <meta property="og:image" content="http://harukarist.php.xdomain.jp/choju-acchi/img/twitter-card.png" />
        ...
        <div class="top-page">
          ...
          <?php if(!empty($results)){?>
            <div class="gameover-wrapper">
              ...
              <a href="http://twitter.com/intent/tweet?url=http://harukarist.php.xdomain.jp/choju-acchi/&text=鳥獣戯画とあっち向いてほい！で遊んだよ → PLAYER：<?php echo $playername; ?>、勝った回数：<?php echo $results['winCount']; ?>回、倒した動物：<?php echo $results['knockDownCount']; ?>匹 &related=harukarist&hashtags=鳥獣戯画とあっち向いてほい,ダ鳥獣戯画" class="button">結果をツイート</a>
